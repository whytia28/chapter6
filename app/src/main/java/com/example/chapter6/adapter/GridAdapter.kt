...
import kotlinx.android.synthetic.main.item_grid_forbes.view.*

class GridAdapter(private val listForbes: ArrayList<Forbes>) :
    RecyclerView.Adapter<GridAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view: View =
            LayoutInflater.from(parent.context).inflate(R.layout.item_grid_forbes, parent, false)
